...
const relationshipMappings = [
  ...
  // 祖辈配偶的子女关系（通用）
  { path: ["f", "f", "w", "s"], name: "爸爸的儿子", gender: "both" },
  { path: ["f", "f", "w", "d"], name: "爸爸的女儿", gender: "both" },
  { path: ["f", "f", "h", "s"], name: "爸爸的儿子", gender: "both" },
  { path: ["f", "f", "h", "d"], name: "爸爸的女儿", gender: "both" },
  { path: ["f", "m", "w", "s"], name: "爸爸的儿子", gender: "both" },
  { path: ["f", "m", "w", "d"], name: "爸爸的女儿", gender: "both" },
  { path: ["f", "m", "h", "s"], name: "爸爸的儿子", gender: "both" },
  { path: ["f", "m", "h", "d"], name: "爸爸的女儿", gender: "both" },
  { path: ["m", "f", "w", "s"], name: "妈妈的儿子", gender: "both" },
  { path: ["m", "f", "w", "d"], name: "妈妈的女儿", gender: "both" },
  { path: ["m", "f", "h", "s"], name: "妈妈的儿子", gender: "both" },
  { path: ["m", "f", "h", "d"], name: "妈妈的女儿", gender: "both" },
  { path: ["m", "m", "w", "s"], name: "妈妈的儿子", gender: "both" },
  { path: ["m", "m", "w", "d"], name: "妈妈的女儿", gender: "both" },
  { path: ["m", "m", "h", "s"], name: "妈妈的儿子", gender: "both" },
  { path: ["m", "m", "h", "d"], name: "妈妈的女儿", gender: "both" },
  // 曾祖辈关系（通用）
  ...
  { path: ["d", "h", "d"], name: "女婿的女儿", gender: "both" },
  { path: ["d", "h", "f"], name: "女婿的爸爸", gender: "both" },
  { path: ["d", "h", "h"], name: "女婿的老公", gender: "both" },
  { path: ["d", "h", "m"], name: "女婿的妈妈", gender: "both" },
  { path: ["d", "h", "ob"], name: "女婿的哥哥", gender: "both" },
  { path: ["d", "h", "os"], name: "女婿的姐姐", gender: "both" },
  { path: ["d", "h", "s"], name: "女婿的儿子", gender: "both" },
  { path: ["d", "h", "yb"], name: "女婿的弟弟", gender: "both" },
  { path: ["d", "h", "ys"], name: "女婿的妹妹", gender: "both" },
  ...
  { path: ["f", "w", "f"], name: "妈妈的爸爸", gender: "both" },
  { path: ["f", "w", "m"], name: "妈妈的妈妈", gender: "both" },
  { path: ["f", "w", "ob"], name: "妈妈的哥哥", gender: "both" },
  { path: ["f", "w", "os"], name: "妈妈的姐姐", gender: "both" },
  { path: ["f", "w", "s"], name: "妈妈的儿子", gender: "both" },
  { path: ["f", "w", "w"], name: "妈妈的老婆", gender: "both" },
  { path: ["f", "w", "yb"], name: "妈妈的弟弟", gender: "both" },
  { path: ["f", "w", "ys"], name: "妈妈的妹妹", gender: "both" },
  ...
  { path: ["m", "h", "d"], name: "爸爸的女儿", gender: "both" },
  { path: ["m", "h", "f"], name: "爸爸的爸爸", gender: "both" },
  { path: ["m", "h", "h"], name: "爸爸的老公", gender: "both" },
  { path: ["m", "h", "m"], name: "爸爸的妈妈", gender: "both" },
  { path: ["m", "h", "ob"], name: "爸爸的哥哥", gender: "both" },
  { path: ["m", "h", "os"], name: "爸爸的姐姐", gender: "both" },
  { path: ["m", "h", "s"], name: "爸爸的儿子", gender: "both" },
  { path: ["m", "h", "yb"], name: "爸爸的弟弟", gender: "both" },
  { path: ["m", "h", "ys"], name: "爸爸的妹妹", gender: "both" },
  { path: ["m", "m", "d"], name: "妈妈", gender: "both" },
  { path: ["m", "m", "s"], name: "妈妈", gender: "both" },
  { path: ["m", "m", "yb"], name: "舅公", gender: "both" },
  { path: ["m", "m", "ys"], name: "姨婆", gender: "both" },
  ...
  { path: ["ob", "m", "yb"], name: "舅舅", gender: "both" },
  ...
  { path: ["ob", "w", "f"], name: "嫂子的爸爸", gender: "both" },
  { path: ["ob", "w", "m"], name: "嫂子的妈妈", gender: "both" },
  { path: ["ob", "w", "ob"], name: "嫂子的哥哥", gender: "both" },
  { path: ["ob", "w", "os"], name: "嫂子的姐姐", gender: "both" },
  { path: ["ob", "w", "w"], name: "嫂子的老婆", gender: "both" },
  { path: ["ob", "w", "yb"], name: "嫂子的弟弟", gender: "both" },
  { path: ["ob", "w", "ys"], name: "嫂子的妹妹", gender: "both" },
  ...
  { path: ["os", "h", "f"], name: "姐夫的爸爸", gender: "both" },
  { path: ["os", "h", "h"], name: "姐夫的老公", gender: "both" },
  { path: ["os", "h", "m"], name: "姐夫的妈妈", gender: "both" },
  { path: ["os", "h", "ob"], name: "姐夫的哥哥", gender: "both" },
  { path: ["os", "h", "os"], name: "姐夫的姐姐", gender: "both" },
  { path: ["os", "h", "yb"], name: "姐夫的弟弟", gender: "both" },
  { path: ["os", "h", "ys"], name: "姐夫的妹妹", gender: "both" },
  ...
  { path: ["os", "m", "yb"], name: "舅舅", gender: "both" },
  { path: ["os", "m", "ys"], name: "小姨", gender: "both" },
  ...
  { path: ["s", "d", "ob"], name: "孙女的哥哥", gender: "both" },
  { path: ["s", "d", "os"], name: "孙女的姐姐", gender: "both" },
  { path: ["s", "d", "w"], name: "孙女的老婆", gender: "both" },
  { path: ["s", "d", "yb"], name: "孙女的弟弟", gender: "both" },
  { path: ["s", "d", "ys"], name: "孙女的妹妹", gender: "both" },
  ...
  { path: ["s", "s", "ob"], name: "孙子的哥哥", gender: "both" },
  { path: ["s", "s", "os"], name: "孙子的姐姐", gender: "both" },
  { path: ["s", "s", "w"], name: "孙媳", gender: "both" },
  { path: ["s", "s", "yb"], name: "孙子的弟弟", gender: "both" },
  { path: ["s", "s", "ys"], name: "孙子的妹妹", gender: "both" },
  { path: ["s", "w", "d"], name: "儿媳的女儿", gender: "both" },
  { path: ["s", "w", "f"], name: "儿媳的爸爸", gender: "both" },
  { path: ["s", "w", "m"], name: "儿媳的妈妈", gender: "both" },
  { path: ["s", "w", "ob"], name: "儿媳的哥哥", gender: "both" },
  { path: ["s", "w", "os"], name: "儿媳的姐姐", gender: "both" },
  { path: ["s", "w", "s"], name: "儿媳的儿子", gender: "both" },
